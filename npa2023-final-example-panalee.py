...
accessToken = "Bearer ZWM3YzgwMjQtOTU0MS00MWM4LWExYTAtYWVhNmMxZWUxZWNjODdjNjg0MGMtZTNl_P0A1_bc884c7a-820b-497b-8b60-00b4d15ea95d"
#######################################################################################
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/Boom") == 0:
        ...
        location = message[len("/Boom "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "0d6b7ff9f1706930f73f5df87e26121c",
        }
